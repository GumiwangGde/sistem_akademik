            ...
            <div class="space-y-10"> {{-- Memberi jarak antar seksi dashboard --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-lg border-0 overflow-hidden transform hover:scale-105 transition-all duration-300">
                            ...
                            <div class="p-6">
                                ...
                                <div class="mt-6 pt-4 border-t border-gray-100">
                                    <a href="{{ route('admin.dosen.index') }}" class="text-green-600 hover:text-green-800 text-sm font-medium flex items-center group">
                                        {{ __('Kelola Dosen') }}
                                        <svg class="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                        </svg>
                        ...
                        <div class="bg-white rounded-xl shadow-lg border-0 overflow-hidden transform hover:scale-105 transition-all duration-300">
                            ...
                            <div class="p-6">
                                ...
                                <div class="mt-6 pt-4 border-t border-gray-100">
                                    <a href="{{ route('admin.mahasiswa.index') }}" class="text-yellow-600 hover:text-yellow-800 text-sm font-medium flex items-center group">
                                        {{ __('Kelola Mahasiswa') }}
                                        <svg class="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                        </svg>
                        ...
                        {{-- Kartu Jadwal Kuliah (Sebelumnya Mata Kuliah) --}}
                        <div class="bg-white rounded-xl shadow-lg border-0 overflow-hidden transform hover:scale-105 transition-all duration-300">
                            <div class="h-2 bg-gradient-to-r from-purple-500 to-purple-700"></div>
                            <div class="p-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">{{ __('Jadwal Kuliah') }}</p>
                                        <p class="text-3xl font-bold text-gray-900">{{ number_format($total_jadwal_kuliah) }}</p>
                                        {{-- <p class="text-xs mt-1">
                                ...
                                <div class="mt-6 pt-4 border-t border-gray-100">
                                    <a href="{{ route('admin.matakuliah.index') }}" class="text-purple-600 hover:text-purple-800 text-sm font-medium flex items-center group">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 mb-5 flex items-center">
                        ...
                        {{ __('Sumber Daya Akademik & Data Master') }}
                    </h2>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"> 
                        {{-- Mengubah menjadi 3 kolom untuk mengakomodasi kartu baru --}}
                        ...
                        <div class="bg-gradient-to-br from-indigo-50 via-gray-50 to-white rounded-xl shadow-lg border border-indigo-100 p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div class="flex items-center justify-end pt-4 border-t border-indigo-100">
                                <a href="{{ route('admin.kelas.index') }}" class="relative inline-flex items-center px-6 py-2 overflow-hidden text-sm font-medium text-white bg-indigo-600 rounded-lg group focus:ring-4 focus:ring-indigo-300 focus:outline-none hover:bg-indigo-700 transition-all">
                                    <span class="relative">{{ __('Kelola Kelas') }}</span>
                                </a>
                            </div>
                        </div>

                        {{-- Kartu Manajemen Ruang --}}
                            ...
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="mt-1 inline-block px-2.5 py-0.5 bg-pink-100 text-pink-700 text-xs font-medium rounded-full">
                                        {{-- Jika Anda memiliki logika untuk ruang tersedia, gunakan $available_ruang_count --}}
                                        {{ $available_ruang_count ?? $total_ruang }} {{ __('Tersedia') }} 
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-end pt-4 border-t border-pink-100">
                        ...
                        {{-- KARTU BARU: Master Mata Kuliah --}}
                        <div class="bg-gradient-to-br from-teal-50 via-gray-50 to-white rounded-xl shadow-lg border border-teal-100 p-6 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    <div class="bg-teal-600 p-3 rounded-lg mr-4 shadow-md">
                                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5s3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18s-3.332.477-4.5 1.253"/>
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900">{{ __('Master Mata Kuliah') }}</h3>
                                        <p class="text-sm text-gray-600">{{ __('Katalog Mata Kuliah') }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-2xl font-bold text-teal-600">{{ number_format($total_master_matakuliah) }}</p>
                                    <div class="mt-1 inline-block px-2.5 py-0.5 bg-teal-100 text-teal-700 text-xs font-medium rounded-full">
                                        {{ __('Total MK') }}
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-end pt-4 border-t border-teal-100">
                                <a href="{{ route('admin.mastermatakuliah.index') }}" class="relative inline-flex items-center px-6 py-2 overflow-hidden text-sm font-medium text-white bg-teal-600 rounded-lg group focus:ring-4 focus:ring-teal-300 focus:outline-none hover:bg-teal-700 transition-all">
                                    <span class="relative">{{ __('Kelola Master MK') }}</span>
                                </a>
                            </div>
                        </div>

                        {{-- KARTU BARU: Tahun Ajaran --}}
                        <div class="bg-gradient-to-br from-orange-50 via-gray-50 to-white rounded-xl shadow-lg border border-orange-100 p-6 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    <div class="bg-orange-600 p-3 rounded-lg mr-4 shadow-md">
                                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                           <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900">{{ __('Tahun Ajaran') }}</h3>
                                        <p class="text-sm text-gray-600">{{ __('Periode Akademik') }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-2xl font-bold text-orange-600">{{ number_format($total_tahun_ajaran) }}</p>
                                     <div class="mt-1 inline-block px-2.5 py-0.5 bg-orange-100 text-orange-700 text-xs font-medium rounded-full">
                                        {{ __('Total Periode') }}
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-end pt-4 border-t border-orange-100">
                                <a href="{{ route('admin.tahunajaran.index') }}" class="relative inline-flex items-center px-6 py-2 overflow-hidden text-sm font-medium text-white bg-orange-600 rounded-lg group focus:ring-4 focus:ring-orange-300 focus:outline-none hover:bg-orange-700 transition-all">
                                    <span class="relative">{{ __('Kelola Tahun Ajaran') }}</span>
                                </a>
                            </div>
                        </div>

                        {{-- KARTU BARU: Program Studi --}}
                         <div class="bg-gradient-to-br from-lime-50 via-gray-50 to-white rounded-xl shadow-lg border border-lime-100 p-6 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900">{{ __('Program Studi') }}</h3>
                                        <p class="text-sm text-gray-600">{{ __('Jurusan & Jenjang') }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="text-2xl font-bold text-lime-600">{{ number_format($total_prodi) }}</p>
                                     <div class="mt-1 inline-block px-2.5 py-0.5 bg-lime-100 text-lime-700 text-xs font-medium rounded-full">
                                        {{ __('Total Prodi') }}
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-end pt-4 border-t border-lime-100">
                                <a href="{{ route('admin.prodi.index') }}" class="relative inline-flex items-center px-6 py-2 overflow-hidden text-sm font-medium text-white bg-lime-600 rounded-lg group focus:ring-4 focus:ring-lime-300 focus:outline-none hover:bg-lime-700 transition-all">
                                    <span class="relative">{{ __('Kelola Prodi') }}</span>
                                </a>
                            </div>
                        </div>
                ...
                <section>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-gray-200">
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
                            ...
                            <a href="{{ route('admin.dosen.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-green-300 hover:bg-green-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                            ...
                            <a href="{{ route('admin.mahasiswa.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                            ...
                            {{-- Link Aksi Cepat Jadwal Kuliah --}}
                            <a href="{{ route('admin.matakuliah.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-purple-300 hover:bg-purple-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                                    <svg class="w-7 h-7 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                       <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-purple-700 text-center">{{ __('Jadwal Kuliah') }}</span>
                            </a>

                            <a href="{{ route('admin.kelas.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                            ...
                            <a href="{{ route('admin.ruang.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-pink-300 hover:bg-pink-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                            ...
                            {{-- Aksi Cepat Baru --}}
                            <a href="{{ route('admin.mastermatakuliah.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-teal-300 hover:bg-teal-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                                    <svg class="w-7 h-7 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5s3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18s-3.332.477-4.5 1.253"/>
                                    </svg>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-teal-700 text-center">{{ __('Master MK') }}</span>
                            </a>
                            <a href="{{ route('admin.tahunajaran.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                                    <svg class="w-7 h-7 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-orange-700 text-center">{{ __('Tahun Ajaran') }}</span>
                            </a>
                             <a href="{{ route('admin.prodi.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gray-50 border-2 border-gray-100 hover:border-lime-300 hover:bg-lime-50 transition-all duration-300">
                                <div class="bg-white p-3 rounded-full mb-3 shadow-md group-hover:-translate-y-1 transition-transform">
                                     <svg class="w-7 h-7 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                       <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                                    </svg>
                                </div>
                                <span class="text-sm font-medium text-gray-700 group-hover:text-lime-700 text-center">{{ __('Prodi') }}</span>
                            </a>
                        </div>
                    </div>
                </section>

                {{-- Bagian Status Sistem (jika ada, bisa dipertahankan atau disesuaikan) --}}
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 mb-5 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Status Server Card --}}
                        <div class="bg-gradient-to-br from-green-50 via-white to-green-50 rounded-xl shadow-lg border border-green-100 p-6 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900">{{ __('Server & Database') }}</h3>
                                    <p class="text-sm text-gray-600">{{ __('Konektivitas dan status operasional') }}</p>
                                </div>
                            </div>
                             <div class="space-y-3">
                        ...
                        <div class="bg-gradient-to-br from-cyan-50 via-white to-cyan-50 rounded-xl shadow-lg border border-cyan-100 p-6 hover:shadow-xl transition-shadow duration-300">
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">{{ __('Unduh ringkasan data sistem') }}</p>
                                </div>
                            </div>
                            <div class="space-y-4">
                                @if(Route::has('admin.laporan.unduh')) {{-- Cek apakah route ada --}}
                                ...
                                @else
                                <p class="text-sm text-gray-500">Fitur laporan belum tersedia.</p>
                                @endif
                                <p class="text-xs text-gray-500 text-center border-t border-cyan-100 pt-4 mt-4">
                                    {{ __('Laporan mencakup ringkasan penting data sistem.') }}
                                </p>
                            </div>
                        </div>
                    </div>
