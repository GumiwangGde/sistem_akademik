<x-app-layout>
    ...
    {{-- Content --}}
    <div class="py-12 bg-gradient-to-r from-blue-200 to-blue-400">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-center text-center">
                            ...
                            <a href="#" class="mt-4 bg-blue-600 text-white rounded-full px-6 py-2 hover:bg-blue-700 transition duration-300">Manage Users</a>
                        </div>
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-center text-center">
                            ...
                            <a href="#" class="mt-4 bg-green-600 text-white rounded-full px-6 py-2 hover:bg-green-700 transition duration-300">Manage Dosen</a>
                        </div>

                        {{-- New Users Card --}}
                        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-center text-center">
                            <h4 class="text-xl font-semibold text-yellow-800">{{ __('New Users') }}</h4>
                            <p class="mt-2 text-gray-600">See the number of users who joined this month.</p>
                            <h2 class="text-3xl font-bold text-yellow-600">250</h2>
                            <a href="#" class="mt-4 bg-yellow-600 text-white rounded-full px-6 py-2 hover:bg-yellow-700 transition duration-300">View Details</a>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 bg-gray-50 p-6 rounded-lg shadow-md">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-white p-4 rounded-lg shadow-sm text-center hover:bg-blue-50 transition duration-300">
                                ...
                                <a href="#" class="text-blue-600 hover:underline mt-2">Go to Users</a>
                            </div>
                            ...
                            <div class="bg-white p-4 rounded-lg shadow-sm text-center hover:bg-green-50 transition duration-300">
                                ...
                                <a href="#" class="text-green-600 hover:underline mt-2">Go to Dosen</a>
                            </div>
                            ...
                            <div class="bg-white p-4 rounded-lg shadow-sm text-center hover:bg-yellow-50 transition duration-300">
                                ...
                                <a href="#" class="text-yellow-600 hover:underline mt-2">View Courses</a>
                            </div>
                        </div>
                    </div>
                </div>
