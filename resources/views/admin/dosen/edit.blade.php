                    ...
                    <form action="{{ route('dosen.update', $dosen->id_dosen) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name" class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 transition duration-200" value="{{ $dosen->user->name }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex">
                                    <input type="text" id="username" name="username" class="w-full p-3 border border-gray-300 rounded-l-lg shadow-sm focus:ring-2 focus:ring-indigo-500 transition duration-200" value="{{ substr($dosen->user->email, 0, strpos($dosen->user->email, '@')) }}" required oninput="updateEmail()">
                                    <span class="bg-gray-300 p-3 rounded-r-lg text-gray-700">@it.lecturer.pens.ac.id</span>
                                </div>
                                <input type="hidden" id="email" name="email" value="{{ $dosen->user->email }}"> <!-- Hidden field untuk email lengkap -->
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nidn" name="nidn" class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 transition duration-200" value="{{ $dosen->nidn }}" required>
                            </div>
