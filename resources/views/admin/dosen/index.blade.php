    ...
    <div class="py-8 sm:py-12"> {{-- Padding vertikal halaman --}}
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="space-y-6"> {{-- Memberi jarak antar elemen flash dan card utama --}}
                ...
                @endif
                {{-- Jika ada session('error') juga, tambahkan blok serupa di sini --}}
                    ...
                    <div class="p-4 sm:p-6"> {{-- Padding internal card utama --}}
                                                        ...
                                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                                                <div class="flex items-center justify-center space-x-2">
                                                                    <a href="{{ route('dosen.edit', $item->id_dosen) }}" class="text-blue-600 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 p-1 rounded-md" title="Edit">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                                        </svg>
                                                                    </a>
                                                                    <form action="{{ route('dosen.destroy', $item->id_dosen) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus dosen {{ $item->user->name ?? '' }}? Data terkait dosen ini mungkin akan terpengaruh.');">
                                                                        @csrf
                                                                        @method('DELETE')
                        ...
                        @else
                            <div class="bg-white p-6 sm:p-8 rounded-lg shadow-sm border border-gray-200 text-center">
                                ...
                                <p class="text-gray-600 mb-6">Silakan tambahkan data dosen baru dengan mengklik tombol "Tambah Dosen"</p> {{-- text-gray-500 to text-gray-600 --}}
