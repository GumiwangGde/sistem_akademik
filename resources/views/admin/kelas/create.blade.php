                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('kelas.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="nama_kelas" id="nama_kelas" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                        </div>
