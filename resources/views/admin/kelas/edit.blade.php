...
<x-app-layout>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('kelas.update', $kelas) }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="nama_kelas" id="nama_kelas" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                        </div>
                        ...
                        <div class="form-group mb-4" id="dosen_wali_div">
                            ...
                            <select name="id_dosen_wali" id="id_dosen_wali" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                ...
                                @foreach($dosen as $dosenItem)
                                    <option value="{{ $dosenItem->id_dosen }}" {{ $kelas->id_dosen_wali == $dosenItem->id_dosen ? 'selected' : '' }}>
                                        {{ $dosenItem->nama }}
                                    </option>
                                @endforeach
                            </select>
    ...
    <script>
        ...
        // Cek status default ketika halaman dimuat
