    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Edit Master Mata Kuliah: ') }} <span class="text-indigo-600">{{ $masterMatakuliah->nama_mk }}</span>
            </h2>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-10 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.mastermatakuliah.update', $masterMatakuliah->id_master_mk) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="kode_mk" id="kode_mk" value="{{ old('kode_mk', $masterMatakuliah->kode_mk) }}" required 
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_mk" id="nama_mk" value="{{ old('nama_mk', $masterMatakuliah->nama_mk) }}" required 
                            ...
                            <div>
                                ...
                                <input type="number" name="semester_default" id="semester_default" value="{{ old('semester_default', $masterMatakuliah->semester_default) }}" min="1" max="14"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="id_prodi" id="id_prodi" required
                                    ...
                                    @foreach ($prodiList as $prodi)
                                        <option value="{{ $prodi->id_prodi }}" {{ old('id_prodi', $masterMatakuliah->id_prodi) == $prodi->id_prodi ? 'selected' : '' }}>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4" 
                                          ...
                                          placeholder="Deskripsi singkat mengenai mata kuliah...">{{ old('deskripsi', $masterMatakuliah->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
