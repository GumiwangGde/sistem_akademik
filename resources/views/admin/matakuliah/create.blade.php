...
<x-app-layout>
    <x-slot name="header">
        {{-- Wrapper untuk memastikan card header terpusat dan memiliki lebar maksimal --}}
                ...
                <div class="px-4 py-4 sm:px-6 sm:py-5"> {{-- Menyesuaikan padding internal header card --}}
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-900">{{ __('Tambah Mata Kuliah') }}</h1>
                                <p class="text-sm text-gray-500">Tambahkan mata kuliah baru ke dalam sistem</p>
                            </div>
                        </div>
                        {{-- Tombol kembali bisa ditambahkan di sini jika diperlukan, atau cukup di form --}}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-8 sm:py-12"> {{-- Menyamakan padding vertikal dengan halaman index --}}
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200"> {{-- Menambahkan border --}}
                <div class="p-6 sm:p-8"> {{-- Menyesuaikan padding internal card --}}
                    @if ($errors->any())
                        <div class="mb-6 flex w-full overflow-hidden bg-red-50 rounded-lg shadow-sm border border-red-300">
                            ...
                            <div class="px-4 py-3"> {{-- Menyederhanakan padding pesan error --}}
                                <span class="font-semibold text-red-600">Terjadi kesalahan:</span> {{-- Warna teks disesuaikan --}}
                                <ul class="text-sm text-red-500 mt-1 list-disc list-inside"> {{-- Warna teks disesuaikan --}}
                    ...
                    <form action="{{ route('matakuliah.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            {{-- Baris 1 --}}
                            <div>
                                <label for="kode_mk" class="block text-sm font-medium text-gray-700 mb-1">Kode Mata Kuliah <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label for="nama_mk" class="block text-sm font-medium text-gray-700 mb-1">Nama Mata Kuliah <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                ...
                                <input type="number" id="sks" name="sks" value="{{ old('sks') }}" min="1" max="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="1-6" required />
                            </div>

                            <div>
                                <label for="semester" class="block text-sm font-medium text-gray-700 mb-1">Semester <span class="text-red-500">*</span></label>
                                <select id="semester" name="semester" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                            ...
                            <div>
                                ...
                                <select id="kelas_id" name="kelas_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                            ...
                            <div>
                                <label for="id_dosen" class="block text-sm font-medium text-gray-700 mb-1">Dosen Pengajar <span class="text-red-500">*</span></label>
                                <select id="id_dosen" name="id_dosen" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                            ...
                            <div>
                                <label for="ruang_id" class="block text-sm font-medium text-gray-700 mb-1">Ruang <span class="text-red-500">*</span></label>
