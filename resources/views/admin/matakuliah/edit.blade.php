...
<x-app-layout>
    ...
    <div class="py-8 sm:py-12"> {{-- Menyamakan padding vertikal --}}
                    ...
                    <form action="{{ route('matakuliah.update', $matakuliah->id_mk) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="sks" name="sks" value="{{ old('sks', $matakuliah->sks) }}" min="1" max="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="1-6" required />
                            </div>
                            ...
                            <div>
                                ...
                                <select id="ruang_id" name="ruang_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                                    ...
                                    @foreach($ruang as $ruang_item)
                                        {{-- Asumsi $ruang_item->id_ruang adalah primary key tabel ruang --}}
