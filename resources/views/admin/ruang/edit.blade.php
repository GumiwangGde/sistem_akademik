                    ...
                    <form action="{{ route('admin.ruang.update', $ruang->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                            <div>
                                ...
                                <input type="text" name="nama_ruang" id="nama_ruang" value="{{ old('nama_ruang', $ruang->nama_ruang) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Contoh: Lab RPL Gedung D401" required>
                                @error('nama_ruang')
                            ...
                            <div>
                                ...
                                <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas', $ruang->kapasitas) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" placeholder="Masukkan kapasitas ruang" required min="1">
                                @error('kapasitas')
                                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
