    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Edit Tahun Ajaran: ') }} <span class="text-indigo-600">{{ $tahunAjaran->nama_tahun_ajaran }}</span>
            </h2>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-10 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.tahunajaran.update', $tahunAjaran->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="kode_tahun_ajaran" id="kode_tahun_ajaran" value="{{ old('kode_tahun_ajaran', $tahunAjaran->kode_tahun_ajaran) }}" required 
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_tahun_ajaran" id="nama_tahun_ajaran" value="{{ old('nama_tahun_ajaran', $tahunAjaran->nama_tahun_ajaran) }}" required 
                            ...
                            <div>
                                ...
                                <input type="number" name="tahun_selesai" id="tahun_selesai" value="{{ old('tahun_selesai', $tahunAjaran->tahun_selesai) }}" required 
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required
                                    ...
                                    <option value="direncanakan" {{ old('status', $tahunAjaran->status) == 'direncanakan' ? 'selected' : '' }}>Direncanakan</option>
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_mulai_perkuliahan" id="tanggal_mulai_perkuliahan" value="{{ old('tanggal_mulai_perkuliahan', $tahunAjaran->tanggal_mulai_perkuliahan ? \Carbon\Carbon::parse($tahunAjaran->tanggal_mulai_perkuliahan)->format('Y-m-d') : '') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_selesai_perkuliahan" id="tanggal_selesai_perkuliahan" value="{{ old('tanggal_selesai_perkuliahan', $tahunAjaran->tanggal_selesai_perkuliahan ? \Carbon\Carbon::parse($tahunAjaran->tanggal_selesai_perkuliahan)->format('Y-m-d') : '') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_mulai_frs" id="tanggal_mulai_frs" value="{{ old('tanggal_mulai_frs', $tahunAjaran->tanggal_mulai_frs ? \Carbon\Carbon::parse($tahunAjaran->tanggal_mulai_frs)->format('Y-m-d') : '') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_selesai_frs" id="tanggal_selesai_frs" value="{{ old('tanggal_selesai_frs', $tahunAjaran->tanggal_selesai_frs ? \Carbon\Carbon::parse($tahunAjaran->tanggal_selesai_frs)->format('Y-m-d') : '') }}"
