...
<body class=" font-poppins h-full scroll-smooth">
    ...
    <header class=" sticky top-0 z-50 bg-blue-900">
        <nav class="container flex items-center py-4 px-16">
          ...
          <ul class="hidden sm:flex flex-1 justify-end items-center gap-8 text-bookmark-blue uppercase text-xs">
            <a href="#home" class="text-white hover:text-slate-200 font-semibold">Home</a>
            <a href="#services" class="text-white hover:text-slate-200 font-semibold">Services</a>
            <a href="#aboutUs" class="text-white hover:text-slate-200 font-semibold">About Us</a>
            <a href="#faq" class="text-white hover:text-slate-200 font-semibold">FAQ</a>
            <a href="{{ route('login') }}" class="px-6 py-2 font-semibold text-blue-900 bg-white rounded-full hover:bg-slate-200">Login</a>
          </ul>
      ...
      <div class="container px-4 md:px-12 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 border rounded-lg shadow p-4 md:p-6 text-center">
          ...
          <div class="flex flex-wrap flex-col items-center justify-center px-1 md:px-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-8 dark:text-gray-200">
              <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
            </svg>
            <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-300">Mahasiswa Dosen</h1>
          ...
          <div class="flex flex-wrap flex-col items-center justify-center px-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-6 dark:text-gray-200">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
            </svg>            
            <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-300">Manajemen Mahasiswa</h1>
          ...
          <div class="flex flex-wrap flex-col items-center justify-center px-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-5 dark:text-gray-200">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25" />
            </svg>
            <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-300">Monitoring Akademik</h1>
    ...
    <!-- About Us -->
    <section id="aboutUs" class="container mx-auto p-10 my-5 text-center mt-10">
    ...
    <!-- Footer -->
    <footer id="faq" class="bg-white shadow-lg mt-auto">
